...
def eval_zero_shot_mmlu():
    ...
    save_path = "cs336_alignment/scripts/outputs/zero_shot_mmlu.json"
...
def eval_zero_shot_gsm8k():
    ...
    save_path = "cs336_alignment/scripts/outputs/zero_shot_gsm8k.json"
...
def eval_zero_shot_alpaca():
    ...
    save_path = "cs336_alignment/scripts/outputs/zero_shot_alpaca.json"
...
def eval_zero_shot_sst():
    ...
    save_path = "cs336_alignment/scripts/outputs/zero_shot_sst.jsonl"
...
if __name__ == "__main__":
    ...
    if args.mmlu:
        eval_zero_shot_mmlu()
    if args.gsm8k:
        eval_zero_shot_gsm8k()
    if args.alpaca:
        eval_zero_shot_alpaca()
    if args.sst:
        eval_zero_shot_sst()